  ...
  const formatTime = (dateString: Date) => {
    ...
    return (
        <div>
            ...
            <div className="panel">
            <div className="text-2xl font-semibold uppercase">Trip ke Makkah 4 Oktober 2024</div>
                ...
                <div className="flex flex-col flex-wrap justify-between gap-6 lg:flex-row">
                    <div className="flex-1">
                        <div className="space-y-1 text-white-dark">
                            <div>Pemandu:</div>
                            <div className="font-semibold text-black dark:text-white">{tripData?.picName}</div>
                        </div>
                    </div>
                    <div className="flex flex-col justify-between gap-6 sm:flex-row lg:w-2/3">
                        ...
                        <div className="xl:1/3 sm:w-1/2 lg:w-2/5">
                            <div className="mb-2 flex w-full items-center justify-between">
                                ...
                                <div className="whitespace-nowrap">{tripData ? formatDate(tripData.date) : '-'}</div>                            </div>
                            <div className="mb-2 flex w-full items-center justify-between">
                                <div className="text-white-dark">Standby:</div>
                                <div>{tripData ? formatTime(tripData.stand_by) : '-'}</div>                            </div>
                            <div className="mb-2 flex w-full items-center justify-between">
                                <div className="text-white-dark">Berangkat:</div>
                                <div>{tripData ? formatTime(tripData.start) : '-'}</div>                            </div>
                            <div className="mb-2 flex w-full items-center justify-between">
                                <div className="text-white-dark">Kembali:</div>
                                <div>{tripData ? formatTime(tripData.end) : '-'}</div>                            </div>
                        </div>
                    </div>
                </div>
